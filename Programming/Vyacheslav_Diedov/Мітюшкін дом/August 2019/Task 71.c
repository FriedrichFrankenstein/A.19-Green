...
void inputArr( int n, int arr[100][100]);

void randArr( int n, int arr[100][100]);

void scanfArr( int n, int arr[100][100]);

void rearrangementCrosswise( int n, int arr[100][100]);

void moveClockwise( int n, int arr[100][100]);
